  ...
  return (
    ...
    >
      <VStack flex={1}>
        ...
        >
          <Heading color="white" fontSize={16} fontFamily="heading">
      ...
      >
        <Button width="48%" icon={<ArrowLeft />} onPress={handleGoBack}>
          Voltar e Editar
        </Button>

        <Button width="48%" icon={<Tag color="white" />} variant="primary">
          Publicar
        </Button>
      </HStack>
    </ScrollView>
